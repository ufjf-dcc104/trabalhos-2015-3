        ...
        this.update = function() {
            if(this.vx == 0){
                if(this.keyStatus.pressed('space')) {
                    this.vx = 200;
                    this.shared.sendAction(this.x, this.y, Const.PLAYER_START);
                }
            ...
            if (this.keyStatus.pressed('up') && !this.jump && this.vy == 0) {
                ...
                this.shared.sendAction(this.x, this.y, Const.PLAYER_JUMP);
            } else
            ...
            //(we use gx as points too!)
            this.shared.actualScore = gx;
